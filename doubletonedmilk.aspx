<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="doubletonedmilk.aspx.vb" Inherits="lowfatmilk" %>
...
<div align="center">
    ...
    <asp:Image ID="Image2" runat="server" 
        ImageUrl="~/img/pro img/Double-Toned-Milk low fat milk.jpg" Height="70%" 
        Width="90%" />
 ...
 <div>
    <br />
        ...
        <table align="center" class="style1">
            <tr>
                <td>
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/img/pro img/Double-Toned-Milk low fat milk(1).jpg" />
                    </td>
                <td>
                     <div align="center">
                        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="45px" 
                            Font-Underline="True" Text="Low Fat Milk"></asp:Label>
                        <br />
                        <p>__________________________________________________________________________</p>
                        <p style="font-size: 20px; color: #808080">Choice for fitness enthusiasts! Godhani Double Toned Milk is skimmed for those who like less fat yet power-packed nutrients in their Milk.</p>
                        <p>__________________________________________________________________________</p>
                       <p style="font-size: 20px;">Size :235ml</p>
                        <p>__________________________________________________________________________</p>
                    </div>
                    </td>
            </tr>
