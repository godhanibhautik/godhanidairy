<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="meethadahi.aspx.vb" Inherits="meethadahi" %>
...
<div align="center">
    ...
    <asp:Image ID="Image2" runat="server" 
        ImageUrl="~/img/pro img/meetha dahi.jpg" Height="70%" Width="90%" />
 ...
 <div>
    <br />
        ...
        <table align="center" class="style1">
            <tr>
                <td>
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/img/pro img/meetha dahi(1).jpg" />
                    </td>
                <td>
                   <div align="center">
                        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="45px" 
                            Font-Underline="True" Text="Meetha Dahi"></asp:Label>
                        <br />
                        <p>__________________________________________________________________________</p>
                        <p style="font-size: 20px; color: #808080">Celebrate the sweet moments of life with Godhani Meetha Dahi or just eat for fun! It is made from pure pasteurized milk to assure that only safe and quality products reach your plate. Make this your go-to choice for good gut health!</p>
                        <p>__________________________________________________________________________</p>
                       <p style="font-size: 20px;">Size :85g, 200g</p>
                        <p>__________________________________________________________________________</p>
                    </div>
                    </td>
            </tr>
    ...
    <div align="center">
        ...
        <asp:TextBox ID="txtq1" runat="server" Font-Size="Large"></asp:TextBox>
            ...
            <tr>
                ...
                <td align="center">
                    <asp:Label ID="lblpr2" runat="server" Font-Size="Large" Text="20"></asp:Label>
                </td>
                <td align="center" class="style7">
