<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="cowghee.aspx.vb" Inherits="cowghee" %>
...
<div align="center">
    ...
    <asp:Image ID="Image2" runat="server" 
        ImageUrl="~/img/pro img/Cow ghee.jpg" Height="70%" Width="90%" />
 ...
 <div>
    <br />
        ...
        <table align="center" class="style1">
            <tr>
                <td>
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/img/pro img/Cow ghee(1).png" />
                    </td>
                <td>
                   <div align="center">
                        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="45px" 
                            Font-Underline="True" Text="Cow Ghee"></asp:Label>
                        <br />
                        <p>__________________________________________________________________________</p>
                        <p style="font-size: 20px; color: #808080">Rich in aroma and texture, ghee kindles the digestive fire in the body contributing to better nutrition. Godhani Ghee is made using high-quality milk in the most hygienic and safe conditions to ensure its purity and quality. It builds immunity, maintains cholesterol and helps in digestion.</p>
                        <p>__________________________________________________________________________</p>
    ...
    <div align="center">
        ...
        <table class="style2" align="center" width="100%">
            ...
            <tr>
                ...
                <td class="style4" align="center">
                    <asp:Label ID="lblpr1" runat="server" Font-Size="Large" Text="65"></asp:Label>
                </td>
        ...
        <asp:TextBox ID="txtq1" runat="server" Font-Size="Large"></asp:TextBox>
            ...
            <tr>
                ...
                <td align="center">
                    <asp:Label ID="lblpr2" runat="server" Font-Size="Large" Text="125"></asp:Label>
                </td>
                <td align="center" class="style7">
        <asp:TextBox ID="txtq2" runat="server" Font-Size="Large"></asp:TextBox>
            ...
            <tr>
                ...
                <td align="center">
                    <asp:Label ID="lblpr3" runat="server" Font-Size="Large" Text="310"></asp:Label>
                </td>
                <td align="center" class="style7">
        <asp:TextBox ID="txtq3" runat="server" Font-Size="Large"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="style4" align="center">
                    <asp:Label ID="lblpr4" runat="server" Font-Size="Large" Text="595"></asp:Label>
                </td>
                <td class="style8" align="center">
        <asp:TextBox ID="txtq4" runat="server" Font-Size="Large"></asp:TextBox>
            ...
            <tr>
                ...
                <td align="center">
                    <asp:Label ID="lblpr5" runat="server" Font-Size="Large" Text="2970"></asp:Label>
                </td>
                <td align="center" class="style7">
