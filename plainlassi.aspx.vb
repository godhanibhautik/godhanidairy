...
Partial Class plainlassi
    ...
    Protected Sub btnbuy_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnbuy.Click
        ...
        da = New SqlDataAdapter("insert into plain_lassi(name,mnumber,address,pincode,city,state,size_200ml,size_190ml,total) values('" & txtname.Text & "','" & txtmno.Text & "','" & txtaddress.Text & "','" & txtpincode.Text & "','" & txtcity.Text & "','" & txtstate.Text & "','" & txtq1.Text & "','" & txtq2.Text & "','" & lbltotal.Text & "')", cn)
        ds = New DataSet
        da.Fill(ds)
    ...
    Protected Sub btnserchorder_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnserchorder.Click
        da = New SqlDataAdapter("select * from plain_lassi where name='" & txtname.Text & "'", cn)
        ds = New DataSet
        da.Fill(ds)
    ...
    Protected Sub btnupdateorder_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnupdateorder.Click
        ...
        lbltotal.Text = Val(lblt1.Text) + Val(lblt2.Text)
        da = New SqlDataAdapter("update plain_lassi set name='" & txtname.Text & "',mnumber='" & txtmno.Text & "',address='" & txtaddress.Text & "',pincode='" & txtpincode.Text & "',city='" & txtcity.Text & "',state='" & txtstate.Text & "',size_200ml='" & txtq1.Text & "',size_190ml='" & txtq2.Text & "',total='" & lbltotal.Text & "' where name='" & txtname.Text & "'", cn)
        ds = New DataSet
        da.Fill(ds)
