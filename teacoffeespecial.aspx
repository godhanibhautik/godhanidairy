<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="teacoffeespecial.aspx.vb" Inherits="teacoffeespecial" %>
...
<div align="center">
    ...
    <asp:Image ID="Image2" runat="server" 
        ImageUrl="~/img/pro img/Tea-coffee.jpg" Height="70%" Width="90%" />
 ...
 <div>
    <br />
        ...
        <table align="center" class="style1">
            <tr>
                <td>
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/img/pro img/Tea-coffee(1).jpg" />
                    </td>
                <td>
                    <div align="center">
                        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="45px" 
                            Font-Underline="True" Text="Tea Coffee special"></asp:Label>
                        <br />
                        <p>__________________________________________________________________________</p>
                        <p style="font-size: 20px; color: #808080">Make your special moments even more special! Ideal for all types of tea & coffee, Godhani Tea Coffee Special milk has a rich taste crafted to make the best soothing beverage of your choice. So, whichever tea or coffee recipe you like, Godhani Tea Coffee Special is your best partner to pair it with!</p>
                        <p>__________________________________________________________________________</p>
                       <p style="font-size: 20px;">Size :500 ml, 1L</p>
                        <p>__________________________________________________________________________</p>
                    </div>
                    </td>
            </tr>
            <tr>
                ...
                <p style="font-size: 20px;" align="center">
                                            ...
                                            Protein – 3.2 g<br />
                                            Calcium – 135 mg<br />
                                            Added Vitamin A – 77 IU<br />
                                            Added Vitamin D2 – 55 IU
                 </p>
                <p>__________________________________________________________________________</p>
                 </div>
                   </td>
...
<div align="center">
    ...
    <div align="center">
            ...
            <tr>
                <td class="style6" align="center">
                    <asp:Label ID="Label14" runat="server" Font-Bold="False" Font-Size="Large" 
                        Text="500ml"></asp:Label>
                </td>
                <td class="style4" align="center">
                    <asp:Label ID="lblpr1" runat="server" Font-Size="Large" Text="30"></asp:Label>
                </td>
        ...
        <asp:TextBox ID="txtq1" runat="server" Font-Size="Large"></asp:TextBox>
            ...
            <tr>
                <td class="style5" align="center">
                    <asp:Label ID="Label15" runat="server" Font-Size="Large" Text="1L"></asp:Label>
                </td>
                <td align="center">
                    <asp:Label ID="lblpr2" runat="server" Font-Size="Large" Text="60"></asp:Label>
                </td>
                <td align="center" class="style7">
