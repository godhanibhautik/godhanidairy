<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="cowmilk.aspx.vb" Inherits="cowmilk" %>
...
<div align="center">
    ...
    <asp:Image ID="Image2" runat="server" ImageUrl="~/img/pro img/Cow-Milk.jpg" 
        Height="70%" Width="90%" />
 ...
 <div>
    <br />
        ...
        <table align="center" class="style1">
            <tr>
                <td>
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/img/pro img/Cow-Milk (1).jpg" />
                    </td>
                <td>
                    <div align="center">
                        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="45px" 
                            Font-Underline="True" Text="Cow Milk"></asp:Label>
                        <br />
                        <p>__________________________________________________________________________</p>
                        <p style="font-size: 20px; color: #808080">Packed with the best benefits of milk, strengthen your bones & teeth with the pure, fresh and nutritious Godhani Cow Milk. A storehouse of quality protein, Godhani Cow Milk is a favourite of many!</p>
                        <p>__________________________________________________________________________</p>
                       <p style="font-size: 20px;">Size :500ml</p>
                        <p>__________________________________________________________________________</p>
                    </div>
                    </td>
            </tr>
            ...
            <tr>
                <td class="style6" align="center">
                    <asp:Label ID="Label14" runat="server" Font-Bold="False" Font-Size="Large" 
                        Text="500 ml"></asp:Label>
                </td>
                <td class="style4" align="center">
                    <asp:Label ID="lblpr1" runat="server" Font-Size="Large" Text="28"></asp:Label>
                </td>
