<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="mangolassi.aspx.vb" Inherits="mangolassi" %>
...
<div align="center">
    ...
    <asp:Image ID="Image2" runat="server" 
        ImageUrl="~/img/pro img/mango-lassi.jpg" Height="70%" Width="90%" />
            ...
            <tr>
                <td>
                    <asp:Image ID="Image1" runat="server" 
                        ImageUrl="~/img/pro img/mango-lassi(1).png" />
                    </td>
                <td>
                     <div align="center">
                        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="45px" 
                            Font-Underline="True" Text="Mango Lassi"></asp:Label>
                        <br />
                        <p>__________________________________________________________________________</p>
                        <p style="font-size: 20px; color: #808080">Made only from the best of King Alphonso Mangoes, Godhani Mango Lassi is a fruity, creamy and wholesome refreshment for your summer days. Being the king, it’s good for digestion too! Tastes best when served chilled.</p>
                        <p>__________________________________________________________________________</p>
                       <p style="font-size: 20px;">Size :200ml</p>
                        <p>__________________________________________________________________________</p>
                    </div>
                    </td>
            </tr>
        ...
        <table class="style2" align="center" width="100%" style="width: 100%">
            ...
            <tr>
                ...
                <td class="style4" align="center">
                    <asp:Label ID="lblpr1" runat="server" Font-Size="Large" Text="25"></asp:Label>
                </td>
