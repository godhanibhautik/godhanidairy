<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="plainchaach.aspx.vb" Inherits="plainchaach" %>
...
<div align="center">
    ...
    <asp:Image ID="Image2" runat="server" 
        ImageUrl="~/img/pro img/plain chhach.jpg" Height="70%" Width="90%" />
 ...
 <div>
    <br />
        ...
        <table align="center" class="style1">
            <tr>
                <td>
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/img/pro img/plain chhach(1).jpg" />
                    </td>
                <td>
                    <div align="center">
                        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="45px" 
                            Font-Underline="True" Text="Plain Chaach"></asp:Label>
                        <br />
                        <p>__________________________________________________________________________</p>
                        <p style="font-size: 20px; color: #808080">Refresh with the delicious Godhani Chaach. A refreshing low-calorie drink that can restore energy levels. Aids in digestion. Tastes best when served chill!</p>
                        <p>__________________________________________________________________________</p>
